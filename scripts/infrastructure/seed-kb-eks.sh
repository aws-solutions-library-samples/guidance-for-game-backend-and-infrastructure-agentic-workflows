...
STACK_NAME="${PROJECT_NAME}-kb-eks"
...
echo "=================================================="
echo "☸️ Seeding EKS Knowledge Base"
echo "=================================================="
...
DOCS_DIR="$(cd "$(dirname "$0")/../../docs/kb-sources/eks" && pwd)"
if [ ! -d "$DOCS_DIR" ]; then
...
while [ $ELAPSED -lt $MAX_WAIT ]; do
  ...
  if [ "$STATUS" = "COMPLETE" ]; then
    echo "✅ EKS KB ingestion complete!"
